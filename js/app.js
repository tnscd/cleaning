(() => {
    ...
    window.onload = () => {
        const item = document.querySelector(".services-nav__item");
        if (item) setTimeout((() => {
    ...
    function onClassChange(mutationsList) {
        for (const mutation of mutationsList) if (mutation.type === "attributes" && mutation.attributeName === "class") {
            ...
            const spollers = document.querySelector(".services-page__items");
            if (spollers) if (document.documentElement.classList.contains("menu-open")) console.log("Class menu-open is present"); else {
                console.log("Class menu-open is not present");
                spollers.style.transform = "translateX(0%)";
            } else console.log("Element .services-page__items not found");
        }
    }
    document.addEventListener("DOMContentLoaded", (function() {
    ...
    if (window.innerWidth >= 768 && document.documentElement.classList.contains("menu-open")) document.documentElement.classList.remove("menu-open");
    document.addEventListener("DOMContentLoaded", (function() {
        const navItems = document.querySelectorAll("[data-goto-header]");
        navItems.forEach((item => {
            item.addEventListener("click", (function(event) {
                event.preventDefault();
                const gotoClass = this.getAttribute("data-gotoEl");
                const targetElement = document.querySelector(gotoClass);
                if (targetElement) {
                    const sections = document.querySelectorAll(".house-cleaning, .windows-cleaning, .chemical-cleaning");
                    sections.forEach((section => section.style.order = ""));
                    targetElement.style.order = "1";
                    sections.forEach((section => {
                        if (section !== targetElement) section.style.order = "2";
                    }));
                }
            }));
        }));
    ...
    document.querySelector(".about").addEventListener("click", (function(e) {
        ...
        if (footer) {
            const originalPaddingTop = window.getComputedStyle(footer).paddingTop;
            const originalPosition = window.getComputedStyle(footer).position;
            footer.style.transition = "padding-top 1s";
            footer.style.paddingTop = "40px";
            footer.style.position = "relative";
            setTimeout((function() {
                footer.style.paddingTop = originalPaddingTop;
    ...
    //             center: [ 52.972, 63.119 ],
    //             zoom: 15
    //         });
    //         var address = "Казахстан, Рудный, улица Ленина, 14";
    ...
    document.addEventListener("DOMContentLoaded", (function() {
        ...
        mapButton.style.pointerEvents = "all";
        mapButton.textContent = "Включить прокрутку карты";
        mapButton.addEventListener("click", (function() {
            if (scrollEnabled) {
                map.style.pointerEvents = "all";
                document.body.style.overflow = "hidden";
                mapButton.textContent = "Выключить прокрутку карты";
            } else {
                map.style.pointerEvents = "none";
    ...
    function startMomentumScroll() {
        momentumInterval = setInterval((() => {
            ...
            scrollContainer.scrollTop -= velocity * speedFactor;
            velocity *= friction;
        }), 16);
    }
    const handleMouseMove = e => {
        ...
        scrollContainer.scrollTop = scrollTop - deltaY * speedFactor;
    ...
    document.addEventListener("DOMContentLoaded", (function() {
        ...
        map.style.pointerEvents = "none";
        mapButton.textContent = "Включить карту";
        mapButton.addEventListener("click", (function() {
            if (isMapActive) {
                map.style.pointerEvents = "none";
                document.body.style.overflow = "auto";
                ...
                map.style.pointerEvents = "all";
                document.body.style.overflow = "hidden";
                mapButton.textContent = "Выключить карту";
                scrollContainer.removeEventListener("mousemove", handleMouseMove);
    ...
    class SelectConstructor {
        ...
        selectsActions(e) {
            ...
            if (targetElement.closest(this.getSelectClass(this.selectClasses.classSelect)) || targetElement.closest(this.getSelectClass(this.selectClasses.classSelectTag))) {
                ...
                if (targetType === "click") {} else if (targetType === "focusin" || targetType === "focusout") {
        ...
        selectСlose(selectItem) {
            const selectElementData = this.getSelectElement(selectItem);
            const originalSelect = selectElementData.originalSelect;
            const selectOptions = selectElementData.selectElement;
            if (!originalSelect) {
                console.error("originalSelect is null");
                return;
            }
